...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiamV0c2V0c3JhZGlvIiwiYSI6ImNrcDRvMjgydDFwY2Iyb213aDZhaDVqc24ifQ.swEoGB9npzyFgs4YuwA6NQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/jetsetsradio/ckp4orlv82k3q17mpbc1hbaqd',
    scrollZoom: false //   center: [-73.960536, 40.673056],
    //   zoom: 6,
    //   interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //extends mapbounds to include location
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51IvqtlAKkeLqkGzZXUxSrS2Na7IvuGqPy83DzhT6n4LkzBwEzxJvkb5Qr6ORjLUADhylPmhrUXBTXUdnY4zI3a7M00v28RIUNy'); // Get session from server
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...'; // console.log(e.target);
